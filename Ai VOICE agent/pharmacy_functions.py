...
#this is for storing the drugs and orders in memory
...
#this is a dictionary that maps the function names to the function objects
#the function names are defined in the config.json file
#the function objects are the actual functions that will be called
#this is the key function that will be called by the deepgram agent to execute the functions 
FUNCTION_MAP = {
